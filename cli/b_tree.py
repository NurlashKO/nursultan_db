...
from .db_index import DatabaseIndex


# Source code taken from https://gist.github.com/MartinThoma/3159687
# Thank you MartinThoma! ;)
class _BNode(object):
...
class BTree(object):
    ...
    def _build_bulkloaded_branches(self, data):
        leaves, seps = data[0], data[1]
        minimum = self.order // 2
        levels = [leaves]
...
def tests():
    b = BTree(2)
    for i in range(0, 20):
        b.insert(DatabaseIndex(random.randrange(0, 100), i))
    print(b)
